    ...
    return(
        <div className='bg-pink-100 min-h-screen flex flex-col'>
            ...
            <div className="h-[150%] w-full flex p-6 gap-6">
                <div className="flex flex-col bg-pink-200 rounded-lg p-6 w-1/3 justify-between">
                ...
                <div className="flex flex-col bg-pink-200 rounded-lg p-6 w-1/3 justify-between">
                    ...
                    <button 
                        ...
                        className="bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600 transition w-fit align-bottom"
                    >
                        List of Characters
                    </button>
                </div>
            ...
            <div className="h-[150%] w-full flex p-6 gap-6">
                <div className="w-[96%] bg-pink-200 rounded-lg p-6 h-64 mx-auto justify-between">
